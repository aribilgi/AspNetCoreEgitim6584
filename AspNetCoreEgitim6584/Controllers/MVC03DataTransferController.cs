...
namespace AspNetCoreEgitim6584.Controllers
{
    public class MVC03DataTransferController : Controller
    {
        ...
        public ActionResult Index(string text1, string ddlListe, bool cbOnay, IFormCollection formCollection) // formCollection nesnesi ekrandaki form elementi içerisindeki alanlara ulaşmamızı sağlar
        {
            ...
            TempData["Tdata2"] = "checkbox dan seçilen değer : " + formCollection["cbOnay"][0]; // checkbox için
            ...
            TempData["Tdata3"] = "checkbox dan seçilen değer : " + Request.Form["cbOnay"][0]; // checkbox için
            return View();
        }
    }
}
